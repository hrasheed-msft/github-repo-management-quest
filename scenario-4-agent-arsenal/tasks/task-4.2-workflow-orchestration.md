...
Add this workflow prompt to your `.prompts` file:
...
Run this workflow on sample content:

```
#content-publication-pipeline @workspace Evaluate scenario-1-inheritance/challenge-repo/docs/getting-started.md for publication readiness
```
...
```
#repository-health-check @workspace Conduct a complete health assessment of this repository
```
...
```
#issue-resolution-workflow Analyze and create resolution plan for: [paste issue description or URL]
```
...
Create prompts that explicitly pass context between agents:
...
- [ ] 3 complex workflows implemented and tested
